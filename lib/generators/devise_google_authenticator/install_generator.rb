    ...
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_configs
        inject_into_file "config/initializers/devise.rb",
          ...
          "  # How long should the user have to enter their token." \
          " To change the default, uncomment and change the below:\n" \
          "  # config.ga_timeout = 3.minutes\n\n" \
          "  # Change time drift settings for valid token values." \
          " To change the default, uncomment and change the below:\n" \
          "  # config.ga_timedrift = 3\n\n" \
          "  # Change setting to how long to remember device before requiring another token." \
          " Change to nil to turn feature off.\n" \
          "  # To change the default, uncomment and change the below:\n" \
          "  # config.ga_remembertime = 1.month\n\n" \
          "  # Change setting to assign the application name used by code generator." \
          " Defaults to Rails.application.class.parent_name.\n" \
          "  # To change the default, uncomment and change the below:\n" \
